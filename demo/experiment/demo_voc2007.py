...
from experiment.voc2012 import Voc2012Classification
parser = argparse.ArgumentParser(description='Model Training')
parser.add_argument('--data', default='/home/yuly/multiclass/PascalVOC',
                    help='path to dataset (e.g. ../data/')
parser.add_argument('--image-size', '-i', default='299', type=str,
